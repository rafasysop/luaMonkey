...
local listPosicoes = {
    ...
    [4] = { ['x'] = 23.96, ['y'] = -980.54, ['z'] = 29.3 },
    [6] = { ['x'] = 239.27, ['y'] = -939.34, ['z'] = 29.29},
    [7] = { ['x'] = 263.69, ['y'] = -872.88, ['z'] = 29.17 },
    [8] = { ['x'] = 224.49, ['y'] = -858.74, ['z'] = 30.12 },
    [9] = { ['x'] = 185.85, ['y'] = -844.58, ['z'] = 31.1 }
}
...
Citizen.CreateThread(function()
    while true do 
        ...
        local coordsPlayer = GetEntityCoords(pedPalyer)
            ...
            if diffDistance < 10.0 then 
                time = 1
                DrawMarker(21,listPosicoes[pos].x,listPosicoes[pos].y,listPosicoes[pos].z,0,0,0,0,0,0,1.00,1.00,1.00,255,6,6,100,0,0,0,1)

                if diffDistance < 2.0 then 
                    drawTxt("PRESSIONE  ~g~E~w~  PARA SELECIONAR", 4, 0.5, 0.93, 0.50, 255, 255, 255,180)
